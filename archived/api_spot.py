...
class APISpot(CloudClient):
    ...
    def sub_to_main(self,  amount:str, currency:str, subaccount:str):
        param = {
        ...
        return self._request_with_params(POST, API_SUB_TO_MAIN_URL,param, Auth.SIGNED)

    def main_to_sub(self, amount:str, currency:str, sub_account:str):
        param = {
            'requestNo': str(uuid.uuid1()),
            'amount':amount,
            'currency': currency,
        ...
        return self._request_with_params(POST, API_MAIN_TO_SUB_URL, param, Auth.SIGNED)
